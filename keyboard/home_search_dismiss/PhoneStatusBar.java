...
//        }
    ...
    private void prepareNavigationBarView() {
		...
		//	mNavigationBarView.getSubButton().setVisibility(View.VISIBLE);
		//	mNavigationBarView.getAddButton().setVisibility(View.VISIBLE);
		// }else{
		//	mNavigationBarView.getSubButton().setVisibility(View.GONE);
		//	mNavigationBarView.getAddButton().setVisibility(View.GONE);
		// }
